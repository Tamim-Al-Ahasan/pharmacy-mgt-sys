...
function createData(name, packs, shelf, row, col, price) {
  return {
    name,
    packs,
    shelf,
  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell align="right">{row.packs}</TableCell>
...
const rows = [
  createData('Drug A', 159, 6, 4, 4, 3),
  createData('Drug B', 237, 9, 7, 4, 4),
  createData('Drug C', 262, 16, 2, 6, 3),
  createData('Drug D', 305, 3, 6, 4, 2),
  createData('Drug E', 356, 16, 9, 3, 1),
];
      ...
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Boxes Available</TableCell>
